...
public abstract class MultithreadEventExecutorGroup extends AbstractEventExecutorGroup {
    ...
    protected MultithreadEventExecutorGroup(int nThreads, Executor executor, Object... args) {
        //INSTANCE 是 根据线程数(奇偶)创建相对应的线程选择器
        this(nThreads, executor, DefaultEventExecutorChooserFactory.INSTANCE, args);
    }

    /**
     * Create a new instance. 最终的创建实例构造器
     *
     * @param nThreads       the number of threads that will be used by this instance. 该实例将使用的线程数
     * @param executor       the Executor to use, or {@code null} if the default should be used.    将要使用的executor, 默认为null
     * @param chooserFactory the {@link EventExecutorChooserFactory} to use.      将要使用的EventExecutorChooserFactory
     * @param args           arguments which will passed to each {@link #newChild(Executor, Object...)} call
     */
