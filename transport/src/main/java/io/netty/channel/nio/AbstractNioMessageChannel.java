...
public abstract class AbstractNioMessageChannel extends AbstractNioChannel {
    ...
    private final class NioMessageUnsafe extends AbstractNioUnsafe {
        ...
        public void read() {
            ...
            //服务端的pipeline 由Head -> ServerHandler -> ServerBootstrapAcceptor -> Tail组成
    ...
    /**
     * 在循环体内对消息进行发送，从ChannelOutboundBuffer弹出一条消息进行处理，如果消息为空，说明发送缓冲区为空，所有消息都已经被发送完成。清除写半包标识，退出循环。
     */
    @Override
